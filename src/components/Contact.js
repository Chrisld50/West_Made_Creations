    ...
    return (
        <div>
            ...
            <div className={'contactBackground'}>
                ...
                <p> If you are interested in a build,<br/> have any questions or difficulties with your build,<br/> here is how you can get ahold of me. </p>
            ...
            <div> 
                ...
                <p>The background image used was originally <br/> created by starline on Freepik.  </p>
            </div>
